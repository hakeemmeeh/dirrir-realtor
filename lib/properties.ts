...
export const FALLBACK_PROPERTIES: Property[] = [
  ...
  },
  {
    ...
    areaSqft: 1050,
    location: "Kilimani",
    addressLine: "Kilimani — Argwings Kodhek corridor",
    city: "Nairobi",
    country: "Kenya",
    availableFrom: "Under construction",
    structureType: "Mixed-use retail podium with residential apartments above",
    exteriorMaterial: "Glass curtain wall, composite cladding, and accent stone",
    extraDetails:
      "Ground and first floors retail / F&B; upper floors residential apartments with dedicated lobby and parking core.",
    tagline: "Kilimani · Mixed-use mall and residences",
    ...
    featured: true,
    description:
      "Kilimani Mall is a mixed-use ongoing development pairing a retail podium with residential apartments above. Investor focus: footfall-anchored retail revenue at the base, with stable residential rental yield from the upper floors. Located along the Argwings Kodhek corridor with quick access to Yaya, Adams Arcade, and the wider Kilimani business district.",
    amenities: [
      "Mixed retail podium",
      "Resident lobby",
